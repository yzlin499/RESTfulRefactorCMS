...
public class DisposeAOP {
    private static final Logger log = LogManager.getLogger(DisposeAOP.class);

    @Pointcut("execution(* com.zhbit.cms.servlet.CommonDispose.*(..)) || " +
            "execution(* com.zhbit.cms.servlet.Query.index(..))" +
            " && !execution(* com.zhbit.cms.servlet.CommonDispose.setApplicationContext())")
